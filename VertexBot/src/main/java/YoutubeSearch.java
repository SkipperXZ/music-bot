...
public class YoutubeSearch {
    ...
    public static Credential authorize() throws IOException {
        // Load client secrets.
        InputStream in =
                YoutubeSearch.class.getResourceAsStream("/client_secret.json");
    ...
    public static String search(String keyword) throws IOException {
        ...
        try {
            ...
            url =  "https://www.youtube.com/watch?v="+response.getItems().get(0).getId().getVideoId();
